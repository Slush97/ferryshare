...
First release of the **Ferry** fork (formerly RQuickShare). Ships with a paper-themed UI overhaul, several core protocol fixes, and a refreshed dependency tree.

### ⚠ BREAKING CHANGES

* The legacy (Tauri V1) variant was removed upstream and is no longer built — only the main (Tauri V2) app ships ([378d8ae](https://github.com/Slush97/ferryshare/commit/378d8ae)).

### Highlights

* **Rebrand** RQuickShare → Ferry: new name, icons, package metadata ([0ff1f86](https://github.com/Slush97/ferryshare/commit/0ff1f86))
* **Paper-themed UI redesign** with full frontend refactor and Tailwind 3 → 4 port ([6b4fde6](https://github.com/Slush97/ferryshare/commit/6b4fde6), [97542e4](https://github.com/Slush97/ferryshare/commit/97542e4), [80affdc](https://github.com/Slush97/ferryshare/commit/80affdc))
* **In-app preview** for received files ([4588b44](https://github.com/Slush97/ferryshare/commit/4588b44))
* **Tray polish**: left-click-to-open, lighter tray icon on non-macOS ([ff889d9](https://github.com/Slush97/ferryshare/commit/ff889d9))
* **Header sun/moon toggle** for quick light/dark switch ([055de86](https://github.com/Slush97/ferryshare/commit/055de86))

### UI / UX

* Empty-state region is now a full click-target dropzone with always-visible affordance ([88f9c74](https://github.com/Slush97/ferryshare/commit/88f9c74))
* Pressable hover state on clickable peers ([970dd7d](https://github.com/Slush97/ferryshare/commit/970dd7d))
* Tri-fold paper creases and paper-unfold animation on app open ([ad3e3b7](https://github.com/Slush97/ferryshare/commit/ad3e3b7))
* Toast + auto-clear on send completion ([6c1ac8d](https://github.com/Slush97/ferryshare/commit/6c1ac8d))
* Typographic / structural polish: letterhead, fold, diary italics, toast tone ([0a1349f](https://github.com/Slush97/ferryshare/commit/0a1349f))
* Postmark pulse + fluid empty-state for narrow windows ([2563c1f](https://github.com/Slush97/ferryshare/commit/2563c1f), [7b900a2](https://github.com/Slush97/ferryshare/commit/7b900a2))
* Restore pointer cursor on interactive elements ([a738718](https://github.com/Slush97/ferryshare/commit/a738718))
* Larger default window with a minimum size, centred on open ([12f6a27](https://github.com/Slush97/ferryshare/commit/12f6a27))

### Bug Fixes

* **core_lib**: tolerate extra frames before Introduction — improves compatibility with some senders ([ea2eb6a](https://github.com/Slush97/ferryshare/commit/ea2eb6a))
* **linux**: disable WebKitGTK DMABUF / compositing to dodge a Wayland crash ([04525dd](https://github.com/Slush97/ferryshare/commit/04525dd))
* Open external files / URLs via a custom Rust command for reliability ([9173dfc](https://github.com/Slush97/ferryshare/commit/9173dfc))
* Lowercase `packageName` so the Wayland icon match works ([#294](https://github.com/Slush97/ferryshare/issues/294), [d17c714](https://github.com/Slush97/ferryshare/commit/d17c714))

### Dependencies

* **core_lib**: `prost 0.13 → 0.14`, `rand 0.9 → 0.10`, `ts-rs 10 → 12`, `sha2 0.10 → 0.11`, `hmac/hkdf 0.12 → 0.13`, `btleplug 0.11 → 0.12`
* **app/main**: frontend stack + Rust transitive bumps (vite, postcss, tokio, notify-rust, quick-xml, tao, wry)

### Build & CI

* `release-please` and the build matrix consolidated into a single workflow so binaries attach automatically when a release is cut ([bd07166](https://github.com/Slush97/ferryshare/commit/bd07166))
* Standard fork-hygiene cleanup of CI permissions and triggers ([bf91b1f](https://github.com/Slush97/ferryshare/commit/bf91b1f))
